...
func (u Uint128) Mul64(v uint64) Uint128 {
	...
	hi, c0 := bits.Add64(hi, p1, 0)
	if p0 != 0 || c0 != 0 {
		panic("mul64: overflow: u=" + u.String() + ", v=" + fmt.Sprint(v))
	}
	return Uint128{lo, hi}
}
...
func (u Uint128) Mul64Error(v uint64) (Uint128, error) {
	...
	finalHi, carry := bits.Add64(hi1, hiPart, 0)
	if hi2 > 0 || carry > 0 {
...
func (u *Uint128) Scan(s fmt.ScanState, ch rune) error {
	...
	if err := i.Scan(s, ch); err != nil {
		...
		return errors.New("value cannot be negative: " + i.String())
	} else if i.BitLen() > 128 {
		return errors.New("value overflows Uint128: " + i.String())
	}
	u.Lo = i.Uint64()
...
func FromBig(i *big.Int) (u Uint128) {
	if i.Sign() < 0 {
		panic("FromBig: value cannot be negative: " + i.String())
	} else if i.BitLen() > 128 {
		panic("FromBig: value overflows Uint128: " + i.String())
	}
	u.Lo = i.Uint64()
	u.Hi = i.Rsh(i, 64).Uint64()
	return u
