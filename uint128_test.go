...
func TestOverflowAndUnderflow(t *testing.T) {
	...
	// should panic
	checkPanic(func() { _ = x.Add(y) }, "add: overflow: u=340282366920938463463374607431768211455, v=184467440737095516170")
	checkPanic(func() { _ = x.Add64(10) }, "add64: overflow: u=340282366920938463463374607431768211455, v=10")
	checkPanic(func() { _ = y.Sub(x) }, "sub: underflow: u=184467440737095516170, v=340282366920938463463374607431768211455")
	checkPanic(func() { _ = z.Sub64(math.MaxInt64) }, "sub64: underflow: u=10, v=9223372036854775807")
	checkPanic(func() { _ = x.Mul(y) }, "mul: overflow: u=340282366920938463463374607431768211455, v=184467440737095516170")
...
func BenchmarkArithmetic(b *testing.B) {
	...
	x, y = randUint128().Div64(3), randUint128().Div64(3)
	...
	x, y = randUint128().Div64(3), Uint128{2, 0}
